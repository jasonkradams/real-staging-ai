...
// ImageHandler contains the HTTP handlers for image operations.
type ImageHandler struct {
	imageService image.Service
}

// NewImageHandler creates a new ImageHandlers instance.
...
func (s *ImageHandler) createImageHandler(c echo.Context) error {
...
func (s *ImageHandler) getImageHandler(c echo.Context) error {
	imageID := c.Param("id")
	if imageID == "" {
		return c.JSON(http.StatusBadRequest, ErrorResponse{
			Error:   "bad_request",
...
func (s *ImageHandler) getProjectImagesHandler(c echo.Context) error {
...
func (s *ImageHandler) deleteImageHandler(c echo.Context) error {
	imageID := c.Param("id")
	if imageID == "" {
		return c.JSON(http.StatusBadRequest, ErrorResponse{
			Error:   "bad_request",
